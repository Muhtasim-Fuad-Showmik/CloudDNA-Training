		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#aiclouddnatraining00zhoui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aiclouddnatraining00zhoui5-display": {
								"semanticObject": "aiclouddnatraining00zhoui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ai.clouddna.training00.zhoui5",
									"url": sap.ui.require.toUrl("ai/clouddna/training00/zhoui5")
								}
							}
						}
					}
